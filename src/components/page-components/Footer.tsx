...
import { Code, Mail, MapPin, Phone, Globe, Twitter, Facebook, Instagram, Github, ExternalLink } from 'lucide-react';
      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div>
            <div className="flex items-center space-x-2 mb-6">
              <Code className="text-olympiad-blue" size={24} />
              <span className="text-xl font-semibold">RwIO</span>
            </div>
            <p className="text-gray-300 mb-6">
            Promoting excellence in algorithmic and programming competitions within Rwanda.            </p>
            <div className="flex space-x-4">
              ...
              <a href="https://github.com" className="bg-white/10 hover:bg-white/20 p-2 rounded-full transition-colors" aria-label="GitHub">
                <Github size={18} />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/resources" className="text-gray-300 hover:text-white transition-colors">Problem Archive</Link>
              </li>
              <li>
                <Link href="/team" className="text-gray-300 hover:text-white transition-colors">Competitors</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/sponsors" className="text-gray-300 hover:text-white transition-colors">Our Sponsors</Link>
              </li>
              <li>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">
                  Rwanda Informatics Olympiad<br />
                  Kgali Rwanda
                </span>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 text-olympiad-blue mr-3" />
                <a href="mailto:info@informatics-olympiad.org" className="text-gray-300 hover:text-white transition-colors">
                Drop Us an Email
                </a>
              </li>
              <li className="flex items-center">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-center items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} International Informatics Olympiad. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
